...
def garantir_tabela(cursor):
    """Cria a tabela se não existir, incluindo os campos de integração ZapSign."""
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS assets (
            ...
            codigo_oportunidade TEXT UNIQUE, -- Chave de vínculo com ZapSign
    ...
    with open(csv_path, mode='r', encoding='utf-8-sig') as f:
        ...
        for index, row in enumerate(reader):
            try:
                ...
                # --- NOVIDADE: Captura o código da oportunidade ---
                # Se não houver coluna 'codigo_oportunidade', usamos o public_code como identificador único
                cod_oportunidade = row.get('codigo_oportunidade', public_code).strip()
